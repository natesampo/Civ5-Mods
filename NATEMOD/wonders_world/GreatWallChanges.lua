function NATEMOD_GreatWall_PlayerDoTurn(iPlayer)
	...
	if (player:IsEverAlive()) then
		...
		if (hasGreatWall) then
			...
			GameEvents.PlayerDoTurn.Remove(NATEMOD_GreatWall_PlayerDoTurn);
		end

	end
end
GameEvents.PlayerDoTurn.Add(NATEMOD_GreatWall_PlayerDoTurn);